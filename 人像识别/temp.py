...
class UiForm():
    ...
    def openpb(self):
        ...
        openfile_name_pb, _ = QFileDialog.getOpenFileName(self.btn_add_file, '选择pb文件', '/home/kanghao/',
                                                          'pb_files(*.pb)')
        print('加载模型文件地址为：' + str(openfile_name_pb))

    def openpic(self):
        global openpic_name
        openpic_name, _ = QFileDialog.getOpenFileName(self.btn_open_pic, '选择识别图片', '/home/kanghao/',
                                                      'image files(*.jpg)')
    ...
    def openpbtxt(self):
        ...
        openfile_name_pbtxt, _ = QFileDialog.getOpenFileName(self.btn_add_pbtxt, '选择pbtxt文件', '/home/kanghao/',
                                                             'pbtxt_files(*.pbtxt)')
